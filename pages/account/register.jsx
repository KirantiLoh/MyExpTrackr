...
const RegisterPage = () => {
  ...
  return (
    <div className={loginStyles.loginPage}>
            ...
            <div>
                    <p><input required style={{borderColor:  errorMessage ? "var(--error-color)" : "var(--primary-color)"}} type="email" name='email' value={email} id='id_email' placeholder='Email' onChange={e => setEmail(e.target.value)}/></p>
                    <p><input required style={{borderColor:  errorMessage ? "var(--error-color)" : "var(--primary-color)"}} type="text" name='name' value={name} id='id_username' placeholder='Username' onChange={e => setName(e.target.value)}/></p>
                    <p><input required style={{borderColor:  errorMessage ? "var(--error-color)" : "var(--primary-color)"}} type="password" name="password1" ref={password1Ref} value={password1} id="id_password1" placeholder='Password' onChange={e => setPassword1(e.target.value)}/></p>
                    <p><input required style={{borderColor:  errorMessage ? "var(--error-color)" : "var(--primary-color)"}} type="password" name="password2" ref={password2Ref} value={password2} id="id_password2" placeholder='Confirm Password' onChange={e => setPassword2(e.target.value)}/></p>
